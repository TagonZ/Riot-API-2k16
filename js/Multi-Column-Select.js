...
//private functions
    ...
    var generateitems = function (selector, useOptionText, idprefix, itemClass, containerClass) {
        ...
        } else { //useOptionText false dodanie kustomoweg o atrybutu i pobieranie i wstawianie obrazka zamiast tekstu
			var img = $(selector).attr('data-image');
			settext = "<img src='" + img + "' height='155' width='155' alt='" + $(selector).attr('value') + "'>";
		}
